...
**Phase 2: Server Actions & UI (Steps 8-10)** 8. **Create Server Action**: Implement toggleBookmarkAction 9. **Create Bookmark Hook**: Build useBookmark hook with optimistic updates (React) 10. **Create Bookmark Button**: Build BookmarkButton UI component (React)

**Phase 3: Integration (Steps 11-14)** 11. **Integrate Detail Page**: Add bookmark button to bobblehead detail page (React) 12. **Create Collection Page**: Build bookmarks collection page (React) 13. **Add Dashboard Tab**: Add bookmarks tab to navigation (React) 14. **Update Routes**: Generate type-safe routes

**Phase 4: Testing (Steps 15-19)** 15. **Query Tests**: Test BookmarksQuery class 16. **Facade Tests**: Test BookmarksFacade logic 17. **Action Tests**: Test toggleBookmarkAction 18. **Hook Tests**: Test useBookmark hook 19. **Component Tests**: Test BookmarkButton component
