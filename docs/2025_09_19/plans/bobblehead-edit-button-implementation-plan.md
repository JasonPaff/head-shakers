...
12-18. Various form section components (acquisition-details, physical-attributes, item-settings, custom-fields, item-photos)
19. Form utilities and action pattern references
