# Home Page Redesign - Orchestration Index

**Created**: 2025-11-24T${new Date().toISOString().split('T')[1]}
**Feature**: Home page visual upgrade with featured bobbleheads section
**Status**: In Progress

## Workflow Overview

This orchestration coordinates the home page redesign feature through a 3-step process:
...
- [Final Implementation Plan](../../plans/home-page-redesign-implementation-plan.md)
