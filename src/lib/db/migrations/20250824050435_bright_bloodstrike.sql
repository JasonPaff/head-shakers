CREATE TYPE "public"."target_type" AS ENUM('bobblehead', 'collection', 'user', 'comment');--> statement-breakpoint
...
CREATE TYPE "public"."content_type" AS ENUM('bobblehead', 'collection', 'user');--> statement-breakpoint
...
CREATE TYPE "public"."related_type" AS ENUM('bobblehead', 'collection', 'comment', 'user');--> statement-breakpoint
...
CREATE INDEX "content_views_target_type_id_idx" ON "content_views" USING btree ("target_type","target_id");--> statement-breakpoint
...
CREATE INDEX "comments_target_deleted_idx" ON "comments" USING btree ("target_type","target_id","is_deleted");--> statement-breakpoint
...
CREATE UNIQUE INDEX "likes_unique" ON "likes" USING btree ("user_id","target_type","target_id");--> statement-breakpoint
...
CREATE INDEX "featured_content_content_idx" ON "featured_content" USING btree ("content_type","content_id");--> statement-breakpoint
...
CREATE INDEX "notifications_related_content_idx" ON "notifications" USING btree ("related_type","related_id");--> statement-breakpoint
...
CREATE INDEX "user_activity_target_idx" ON "user_activity" USING btree ("target_type","target_id");--> statement-breakpoint
