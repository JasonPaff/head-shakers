...
export const deleteBobbleheadAction = authActionClient
  ...
  .action(async ({ ctx, parsedInput }) => {
    ...
    try {
      ...
      // TODO: Clean up Cloudinary photos when bobblehead is deleted
      // This would require fetching the photo records first to get their public IDs
      // Then calling CloudinaryService.deletePhotos(publicIds)
