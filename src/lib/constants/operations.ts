...
export const OPERATIONS = {
  ...
  BOBBLEHEADS: {
    ...
    GET_BY_ID: 'get_bobblehead_by_id',
    GET_BY_SLUG: 'get_bobblehead_by_slug',
    GET_BY_SLUG_WITH_RELATIONS: 'get_bobblehead_by_slug_with_relations',
    GET_BY_USER: 'get_bobbleheads_by_user',
    GET_NAVIGATION_DATA: 'get_bobblehead_navigation_data',
    GET_PHOTOS: 'get_bobblehead_photos',
    GET_SEO_METADATA: 'get_bobblehead_seo_metadata',
    GET_WITH_RELATIONS: 'get_bobblehead_with_relations',
  ...
  FEATURED_CONTENT: {
    ...
    GET_FEATURED_BOBBLEHEAD: 'get_featured_bobblehead',
