...
export const FeaturedContentForm = withFocusManagement(
  ({ contentId, onClose, onSuccess }: FeaturedContentFormProps) => {
          ...
          >
            ...
            <div className={'space-y-4'}>
              ...
              <form.AppField name={'title'}>
                {(field) => (
                  <field.TextField isRequired label={'Title'} placeholder={'Enter feature title'} />
                )}
              </form.AppField>
