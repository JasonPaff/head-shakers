...
import { SubcollectionControls } from '@/app/(app)/collections/[collectionSlug]/subcollection/[subcollectionSlug]/components/subcollection-controls';
        ...
        <div className={'grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3'}>
          {bobbleheads.map((bobblehead) => (
            <BobbleheadGalleryCard
              ...
              isOwner={isOwner}
              key={bobblehead.id}
              navigationContext={{ collectionId, subcollectionId: subcollection.id }}
            />
          ))}
        </div>
      </Conditional>
