    ...
    <div className={cn('space-y-6', className)} data-testid={planViewerTestId} {...props}>
      ...
      <Card>
        <CardHeader>
          ...
          {planGeneration.refinedRequest && <CardDescription>{planGeneration.refinedRequest}</CardDescription>}
        </CardHeader>
                  ...
                  <Card className={'border'}>
                    ...
                    <CollapsibleContent>
                      <CardContent className={'space-y-3 pt-0'}>
                        ...
                        {/* Validation Commands */}
                        {(() => {
                          const hasValidationCommands = step.validationCommands && step.validationCommands.length > 0;
