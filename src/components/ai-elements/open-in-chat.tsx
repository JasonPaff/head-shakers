  ...
  scira: {
    ...
    icon: (
      ...
      >
        ...
        <path
          d={
            'M760.632 764.337C720.719 814.616 669.835 855.1 611.872 882.692C553.91 910.285 490.404 924.255 426.213 923.533C362.022 922.812 298.846 907.419 241.518 878.531C184.19 849.643 134.228 808.026 95.4548 756.863C56.6815 705.7 30.1238 646.346 17.8129 583.343C5.50207 520.339 7.76433 455.354 24.4266 393.359C41.089 331.364 71.7099 274.001 113.947 225.658C156.184 177.315 208.919 139.273 268.117 114.442'
          }
          stroke={'currentColor'}
          strokeLinecap={'round'}
          strokeLinejoin={'round'}
...
const OpenInContext = createContext<undefined | { query: string }>(undefined);
