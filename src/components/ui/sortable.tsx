...
const SortableRootContext = React.createContext<null | SortableRootContextValue<unknown>>(null);
...
const SortableItemContext = React.createContext<null | SortableItemContextValue>(null);
