...
vi.mock('@/app/(app)/dashboard/collection/(collection)/components/sidebar/sidebar-header', () => ({
...
vi.mock('@/app/(app)/dashboard/collection/(collection)/components/sidebar/sidebar-search', () => ({
  SidebarSearch: ({
    onSearchChange,
    onSearchClear,
    onSortChange,
...
vi.mock('@/app/(app)/dashboard/collection/(collection)/components/sidebar/sidebar-collection-list', () => ({
...
vi.mock(
  '@/app/(app)/dashboard/collection/(collection)/components/sidebar/cards/collection-card-compact',
  () => ({
...
vi.mock(
  '@/app/(app)/dashboard/collection/(collection)/components/sidebar/cards/collection-card-cover',
  () => ({
...
vi.mock(
  '@/app/(app)/dashboard/collection/(collection)/components/sidebar/cards/collection-card-detailed',
  () => ({
...
vi.mock('@/app/(app)/dashboard/collection/(collection)/components/sidebar/sidebar-footer', () => ({
...
vi.mock('@/app/(app)/dashboard/collection/(collection)/components/empty-states/no-collections', () => ({
...
vi.mock(
  '@/app/(app)/dashboard/collection/(collection)/components/empty-states/no-filtered-collections',
  () => ({
